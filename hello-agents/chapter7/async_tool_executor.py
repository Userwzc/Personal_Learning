...
from my_calculator_tool import my_calculator
...
async def test_parallel_execution():
    ...
    my_advanced_search_tool = MyAdvancedSearchTool()
    registry.register_function(
        name = "search",
        func = my_advanced_search_tool.search,
        description = my_advanced_search_tool.description
    )
    registry.register_function(
        name="my_calculator",
        func=my_calculator,
        description="一个可以执行数学计算的工具"
    )
    # 假设已经注册了搜索和计算工具
