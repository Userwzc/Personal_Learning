...
class ToolChain:
    ...
    def add_step(self, tool_name: str, input_template: str, output_key: str = None):
        ...
        Args:
            ...
            output_key (str, optional): 输出结果的键名，用于后续步骤引用, Defaults to None.
        """
        self.steps.append({
            "tool_name": tool_name,
    ...
    def execute(self, registry: ToolRegistry, initial_input: str, context: Dict[str, Any] = None) -> str:
        ...
        for i, step in enumerate(self.steps,1):
            ...
            try:
                ...
                return f"❌ 错误：步骤 {i} 的输入模板变量缺失: {e}"
            
            print(f"➡️ 步骤 {i}: 调用工具 '{tool_name}' 输入: {tool_input[:50]}...")
        ...
        # 返回最后一步的结果
        finial_result = context[self.steps[-1]["output_key"]]
