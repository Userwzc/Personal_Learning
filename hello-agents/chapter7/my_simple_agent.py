...
class MySimpleAgent(SimpleAgent):
    ...
    def _get_enhanced_system_prompt(self) -> str:
        ...
        # 获取工具描述
        tools_descriptions = self.tool_registry.get_tools_description()
        if not tools_descriptions or tools_descriptions == "暂无可用工具":
            return base_prompt
        
        tools_section = "\n\n## 可用工具\n"
        tools_section += "你可以使用以下工具来帮助你回答问题:\n"
        tools_section += tools_descriptions + "\n"
    ...
    def _parse_tool_parameters(self, tool_name: str, parameters: str) -> dict:
        ...
        if "=" in parameters:
            ...
            if ',' in parameters:
                # 多个参数: action=search,query=Python
