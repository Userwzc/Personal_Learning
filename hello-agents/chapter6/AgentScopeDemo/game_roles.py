...
class GameRoles:
    ...
    ROLES = {
        "狼人": {
            "description": "狼人",
            "abilities": "夜晚可以击杀一名玩家",
            "win_condition": "消灭所有好人或与好人数量相等",
            "team": "狼人阵营"
        },
        "预言家": {
            "description": "预言家",
            "abilities": "每晚可以查验一名玩家的身份",
            "win_condition": "消灭所有狼人",
            "team": "好人阵营"
        },
        "女巫": {
            "description": "女巫",
            "abilities": "拥有解药和毒药各一瓶，可以救人或杀人",
            "win_condition": "消灭所有狼人",
            "team": "好人阵营"
        },
        "猎人": {
            "description": "猎人",
            "abilities": "被杀时可以开枪带走一名玩家",
            "win_condition": "消灭所有狼人",
            "team": "好人阵营"
        },
        "村民": {
    ...
    def get_role_ability(cls, role: str) -> str:
        """获取角色能力"""
        return cls.ROLES.get(role, {}).get("abilities", "无特殊能力")
    
    @classmethod
    def get_character_trait(cls, character: str) -> str:
        """获取角色性格特征"""
        return cls.CHARACTER_TRAITS.get(character, "性格温柔，说话得体")
