    ...
    def registerTool(self, name: str, description: str, func: callable):
        ...
        if params:
            ...
            for param_name, param in params.items():
                ...
                default_value = f" (默认值: {param.default})" if param.default != inspect.Parameter.empty else ""
                param_descriptions.append(f"{param_name}: {param_type}{default_value}")
            description += "参数:" + " ".join(param_descriptions)
...
if __name__ == '__main__':
    ...
    tool_name = "Search"
    tool_input = "截至2026年1月，英伟达最新的GPU型号是什么"
